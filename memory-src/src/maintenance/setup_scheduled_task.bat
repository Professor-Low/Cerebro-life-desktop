...
schtasks /create /tn "AI Memory Maintenance" /tr "C:\Python313\python.exe C:\Users\marke\NAS-cerebral-interface\src\maintenance\auto_maintenance.py" /sc hourly /mo 6 /st 00:00 /ru "%USERNAME%" /f
